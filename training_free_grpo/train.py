...
async def main(args):
    ...
    if args.domain == "math":
        ...
        from training_free_grpo.admet.verify import verify_func   # ✅ 要确认是这行
        from training_free_grpo.admet.prompts import PROBLEM_WITH_EXPERIENCE_TEMPLATE
        from training_free_grpo.admet.experience import ExperienceUpdater
...
if __name__ == "__main__":
    ...
    parser.add_argument("--domain",type=str,required=True,choices=["math", "web", "admet"],help="domain of the tasks (math/web/admet)")
